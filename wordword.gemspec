...
Gem::Specification.new do |spec|
  spec.name          = "wordword"
  spec.license       = "MIT"
  spec.version       = Wordword::VERSION
  spec.authors       = ["Artur Martsinkovskyi"]
  spec.email         = ["deimoss42@gmail.com"]

  spec.summary       = %q{This is a language-agnostic CLI application for learning new words.}
  spec.description   = %q{This is a language-agnostic CLI application for learning new words.}
